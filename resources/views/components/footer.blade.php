        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-sm-12 mt-4 ">
                ...
                <div class="quick-links">
                    <span class="d-flex">
                        ...
                        <x-button value="Home " type="a" classes="footer-links" />
                    </span>
                    <span class="d-flex">
                        <i class="fa-solid fa-angle-right text-white"></i>
                        <x-button value="Special Offer" type="a" classes="footer-links" />
                    </span>
                    <span class="d-flex">
                        <i class="fa-solid fa-angle-right text-white"></i>
            ...
            <div class="col-lg-3 col-sm-12 mt-4">
                ...
                <div class="quick-links">
                    ...
                    <span class="d-flex">
                        <i class="fa-solid fa-angle-right text-white"></i>
                        <x-button value="Terms & Conditions" type="a" classes="footer-links" />
                    </span>
                    <span class="d-flex">
                        <i class="fa-solid fa-angle-right text-white"></i>
                        <x-button value="Privacy Policy" type="a" classes="footer-links" />
                    </span>
                </div>
            </div>
            <div class="col-lg-3 col-sm-12 mt-4">
